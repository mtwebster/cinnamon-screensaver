...
class ExtendedKey(Gtk.Button):
    def __init__(self, label, xkey):
        ...
        self.connect("button-press-event", lambda widget, event: self.xkey.press())
        self.connect("button-release-event", lambda widget, event: self.xkey.release())
...
class Key(Gtk.Button):
    ...
    def get_extended_keys(self):
        ...
        for xkey in self._extended_keys:
            ...
            box.pack_start(key, False, False, 2)
        ...
        for key in keys:
            ...
            for child in children:
                ...
                if child.props.align == "right":
                    ...
                    left_box.pack_start(button, False, False, 2)

            if right_box_members:
                right_box_members.reverse()

                for member in right_box_members:
                    right_box.pack_end(member, False, False, 2)
